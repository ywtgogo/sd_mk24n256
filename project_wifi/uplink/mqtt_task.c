...
int mqttReconnect(void *v)
{
	...
	//PRINTF("..mqtt .............................................h6...\r\n");
	c->ipstack->disconnect(c->ipstack->my_socket);
#ifdef CPU_MK24FN256VDC12
#ifndef WIFI_MODULE
...
static void sendEvent_to_keyValue(MQTT_SEND_Q_MSG *mq, int enc, int sig, char *strPv, AES_STRUCT *aes, JSON_SEND_EVENT *send_event )
{
	...
	modem_ipaddr_ntoa_r(&netif_default.ip_addr, send_event->send_event_body.src, sizeof(send_event->send_event_body.src));
...
void mqtt_task(void *pvParameters)
{
	...
	{
		client.keepAliveInterval = connectData.keepAliveInterval;
