...
#define DIGIPOT_I2C_CLOCK()   __I2C2_CLK_ENABLE()
...
#define DIGIPOT_I2C_SCL_AF                  GPIO_AF4_I2C2
#define DIGIPOT_I2C_SCL_RCC()                __HAL_RCC_GPIOB_CLK_ENABLE()
...
#define DIGIPOT_I2C_SDA_AF                  GPIO_AF4_I2C2
#define DIGIPOT_I2C_SDA_RCC()                __HAL_RCC_GPIOB_CLK_ENABLE()
...
#define RF_SWITCH_RCC()                __HAL_RCC_GPIOE_CLK_ENABLE()
