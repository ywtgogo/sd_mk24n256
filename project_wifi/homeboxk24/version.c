...
#if (DEVICE_PLATFORM == DEVICE_PLATFORM_TEST)
	#define PLATFORM " PLAT_TEST"
#elif (DEVICE_PLATFORM == DEVICE_PLATFORM_CLOUD)
	#define PLATFORM " PLAT_CLOUD"
#else
...
const version_info ver_info = {
		...
		.swver = FW_VERSION,
		.sw_info = { __SVN_BRANCH " @ " __SVN_REV ", " __DATE__ ", " __TIME__ PLATFORM},
};
#else
const version_info ver_info = {
