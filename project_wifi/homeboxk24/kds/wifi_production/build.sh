...
dd if=../../../bootloaderk24/kds/wifi_production/bootloader/hb_bootloader_k24.bin of=produce_img.bin bs=1 seek=0 conv=notrunc
...
mkdir wifi_produce_test
mv fota_node_* project_k24.* ver_info.txt produce_img.bin wifi_produce_test
cd -
...
dd if=../../../bootloaderk24/kds/wifi_production/bootloader/hb_bootloader_k24.bin of=homebox_production.bin bs=1 seek=0 conv=notrunc
